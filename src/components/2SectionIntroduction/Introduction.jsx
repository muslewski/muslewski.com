...
const Introduction = forwardRef(function Introduction(props, refIntroduction) {
  const astronaut = {
    loop: true,
    autoplay: true,
  ...
  return (
    <Section className="pt-12 lg:pt-0 max-w-7xl" id="wprowadzenie">
      <div
        ref={refIntroduction}
        className="bg-blue-200 self-start w-full flex flex-col"
      >
        ...
        <p className="font-description text-secondary dark:text-blue-100 text-xl lg:text-2xl mb-10 leading-normal max-w-3xl self-start">
          ...
          <span className="lg:hidden">
            Chętnie zrealizuję Twój pomysł na imponującą stronę internetową,
            która zachwyci klientów.
          </span>
          <span className="hidden lg:flex">
            Współpracując ze mną, zyskasz technicznego eksperta i partnera,
            który z pasją przekształca Twoje pomysły w rzeczywistość.
          </span>
        </p>
