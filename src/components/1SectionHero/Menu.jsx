...
function Menu() {
  return (
    <menu className="flex justify-between mt-10 mb-4 w-full font-description text-secondary tracking-wide font-bold md:text-lg xl:text-2xl">
      ...
      <MenuItem
        href="#kontakt"
        icon={hire}
        className="animate-delay-[300ms] flex text-2xl lg:text-white lg:bg-gradient-to-bl lg:from-secondary lg:to-[#100072] rounded-md"
      >
        Zatrudnij
      </MenuItem>
    </menu>
