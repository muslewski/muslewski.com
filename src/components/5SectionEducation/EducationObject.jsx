...
function EducationObject({ children, year, achievment }) {
  ...
  return (
    <div className="flex justify-center items-center gap-6 w-full ">
      <h4
        ref={ref}
        className={`font-title font-medium text-2xl lg:text-4xl animate-duration-[3000ms] animate-ease-out ${
      ...
      <h3 className="w-full h-[3.65rem] lg:text-2xl flex items-center">
        {achievment}
      </h3>
    </div>
  );
